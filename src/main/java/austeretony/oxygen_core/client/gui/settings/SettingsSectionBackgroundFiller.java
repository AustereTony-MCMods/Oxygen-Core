...
public class SettingsSectionBackgroundFiller extends OxygenBackgroundFiller {

    public SettingsSectionBackgroundFiller(int xPosition, int yPosition, int width, int height) {             
