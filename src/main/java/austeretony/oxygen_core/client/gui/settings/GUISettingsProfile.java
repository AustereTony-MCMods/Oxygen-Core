...
public class GUISettingsProfile {
    ...
    tooltipTextColor,
    statusElementColor,
    statusElementColorTransparent,
    activeElementColor,
    activeElementColorTransparent,
    inactiveElementColor,
    inactiveElementColorTransparent,
    ...
    public JsonObject serealize() {
        ...
        colorSection.add(EnumSettingsFileKey.STATUS_ELEMENT_COLOR.key, new JsonPrimitive(this.statusElementColor));
        colorSection.add(EnumSettingsFileKey.STATUS_ELEMENT_TRANSPARENT_COLOR.key, new JsonPrimitive(this.statusElementColorTransparent));

        colorSection.add(EnumSettingsFileKey.ACTIVE_ELEMENT_COLOR.key, new JsonPrimitive(this.activeElementColor));
        colorSection.add(EnumSettingsFileKey.ACTIVE_ELEMENT_TRANSPARENT_COLOR.key, new JsonPrimitive(this.activeElementColorTransparent));

        colorSection.add(EnumSettingsFileKey.INACTIVE_ELEMENT_COLOR.key, new JsonPrimitive(this.inactiveElementColor));
        colorSection.add(EnumSettingsFileKey.INACTIVE_ELEMENT_TRANSPARENT_COLOR.key, new JsonPrimitive(this.inactiveElementColorTransparent));
    ...
    public static GUISettingsProfile deserialize(JsonObject object) {
        ...
        profie.statusElementColor = (int) Long.parseLong(section.get(EnumSettingsFileKey.STATUS_ELEMENT_COLOR.key).getAsString(), 16);
        profie.statusElementColorTransparent = (int) Long.parseLong(section.get(EnumSettingsFileKey.STATUS_ELEMENT_TRANSPARENT_COLOR.key).getAsString(), 16);   

        profie.activeElementColor = (int) Long.parseLong(section.get(EnumSettingsFileKey.ACTIVE_ELEMENT_COLOR.key).getAsString(), 16);
        profie.activeElementColorTransparent = (int) Long.parseLong(section.get(EnumSettingsFileKey.ACTIVE_ELEMENT_TRANSPARENT_COLOR.key).getAsString(), 16);

        profie.inactiveElementColor = (int) Long.parseLong(section.get(EnumSettingsFileKey.INACTIVE_ELEMENT_COLOR.key).getAsString(), 16);
        profie.inactiveElementColorTransparent = (int) Long.parseLong(section.get(EnumSettingsFileKey.INACTIVE_ELEMENT_TRANSPARENT_COLOR.key).getAsString(), 16);
