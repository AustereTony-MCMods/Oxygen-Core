...
public class AddRolePrivilegeContextAction implements OxygenContextMenuAction {

    @Override
    public String getLocalizedName(GUIBaseElement currElement) {
        return ClientReference.localize("oxygen_core.gui.privileges.management.addPrivilege");
    }
    ...
    public void execute(GUIBaseElement currElement) {
        ((RolesSection) currElement.getScreen().getWorkspace().getCurrentSection()).openAddPrivilegeCallback();
    }
}
