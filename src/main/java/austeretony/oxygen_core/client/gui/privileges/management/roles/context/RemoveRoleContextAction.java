...
public class RemoveRoleContextAction implements OxygenContextMenuAction {
    ...
    public String getLocalizedName(GUIBaseElement currElement) {
        return ClientReference.localize("oxygen_core.gui.privileges.management.remove");
    }
    ...
    public void execute(GUIBaseElement currElement) {
        ((RolesSection) currElement.getScreen().getWorkspace().getCurrentSection()).openRemoveRoleCallback();
    }
}
