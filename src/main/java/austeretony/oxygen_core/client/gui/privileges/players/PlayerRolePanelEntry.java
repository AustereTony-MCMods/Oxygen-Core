...
public class PlayerRolePanelEntry extends OxygenIndexedPanelEntry<Integer> {
    ...
    public boolean mouseClicked(int mouseX, int mouseY, int mouseButton) {       
        if (this.removeButton.mouseClicked(mouseX, mouseY, mouseButton)) {
            OxygenManagerClient.instance().getPrivilegesManager().removeRoleFromPlayerSynced(this.playerUUID, this.index);
