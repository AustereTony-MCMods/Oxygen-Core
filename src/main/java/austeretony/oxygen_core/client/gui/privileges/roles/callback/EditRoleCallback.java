...
public class EditRoleCallback extends AbstractGUICallback {
    ...
    public EditRoleCallback(PrivilegesScreen screen, RolesSection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new OxygenTextLabel(4, 12, ClientReference.localize("oxygen_core.gui.privileges.callback.editRole"), EnumBaseGUISetting.TEXT_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
    ...
    protected void onOpen() {
        Role role = this.section.getCurrentRole();
