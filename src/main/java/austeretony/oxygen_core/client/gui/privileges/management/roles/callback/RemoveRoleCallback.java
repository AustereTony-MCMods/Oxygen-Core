...
public class RemoveRoleCallback extends AbstractGUICallback {
    ...
    public RemoveRoleCallback(PrivilegesManagementScreen screen, RolesSection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new OxygenTextLabel(4, 12, ClientReference.localize("oxygen_core.gui.privileges.management.callback.removeRole"), EnumBaseGUISetting.TEXT_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));

        this.addElement(new OxygenTextLabel(6, 23, ClientReference.localize("oxygen_core.gui.privileges.management.callback.removeRole.request"), EnumBaseGUISetting.TEXT_SUB_SCALE.get().asFloat(), EnumBaseGUISetting.TEXT_ENABLED_COLOR.get().asInt()));
    ...
    private void confirm() {
        OxygenManagerClient.instance().getPrivilegesManager().removeRoleSynced(this.section.getCurrentRoleEntry().getWrapped().getId());
        this.close();
    }
