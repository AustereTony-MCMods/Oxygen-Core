...
public class OxygenGUIUtils {
    ...
    public static void drawKeyFrame(int x, int y, int width, int height, int baseColor, int additionalColor) {
        //background
        GUISimpleElement.drawRect(x, y, x + width, y + height, baseColor);

        //frame
        OxygenGUIUtils.drawRect(x, y, x + 0.4D, y + height, additionalColor);
        OxygenGUIUtils.drawRect(x + width - 0.4D, y, x + width, y + height, additionalColor);
        OxygenGUIUtils.drawRect(x, y, x + width, y + 0.4D, additionalColor);
        OxygenGUIUtils.drawRect(x, y + height - 0.4D, x + width, y + height, additionalColor);
    }
}
