...
public class InterfaceSettingsSection extends Section {
    ...
    public InterfaceSettingsSection(SettingsScreen screen) {
        super(screen, localize("oxygen_core.gui.settings.interface.title"), true);
        this.screen = screen;
    }
    ...
    public void init() {
        ...
        settings = OxygenManagerClient.instance().getSettingsManager().getSettingsMap().values()
                .stream()
                .filter(e -> e.getType() == SettingType.INTERFACE)
