...
public class SettingsProfile {
    ...
    public JsonObject serealize() {
        ...
        otherSection.add(EnumSettingKeys.USE_TEXTURES_FLAG.key, new JsonPrimitive(this.useTextures));
    ...
    public static SettingsProfile deserialize(JsonObject object) {
        SettingsProfile profie = new SettingsProfile(object.get(EnumSettingKeys.PROFILE_NAME.key).getAsString());
        ...
        profie.useTextures = section.get(EnumSettingKeys.USE_TEXTURES_FLAG.key).getAsBoolean();
