...
public class InteractionOverlay {
    ...
    private GUITextLabel usernameTextLabel, interactKeyTextLabel, interactKeyNameTextLabel;
    ...
    private void draw() {
        ...
        if (this.target instanceof EntityPlayer) {
            ...
            if (!this.initialized) {
                ...
                this.usernameTextLabel.setDisplayText(this.pointedPlayer.getGameProfile().getName(), true);//not safest way to get usernsme on client
