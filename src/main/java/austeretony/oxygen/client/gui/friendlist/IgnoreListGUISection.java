...
import austeretony.oxygen.client.gui.friendlist.ignored.AddIgnoredGUICallback;
import austeretony.oxygen.client.gui.friendlist.ignored.EditNoteContextAction;
import austeretony.oxygen.client.gui.friendlist.ignored.EditNoteGUICallback;
import austeretony.oxygen.client.gui.friendlist.ignored.RemoveIgnoredContextAction;
import austeretony.oxygen.client.gui.friendlist.ignored.RemoveIgnoredGUICallback;
...
public class IgnoreListGUISection extends AbstractGUISection {
    ...
    public void init() { 
        ...
        this.addElement(this.friendsPageButton = new GUIButton(this.getWidth() - 30, 0,  12, 12).setTexture(OxygenGUITextures.FRIENDS_ICONS, 12, 12).initSimpleTooltip(I18n.format("oxygen.gui.friends.tooltip.friends"), GUISettings.instance().getTooltipScale())); 
        ...
        this.addElement(this.addIgnoredButton = new GUIButton(4, this.getHeight() - 11,  40, 10)
