...
public class IgnoreFriendGUICallback extends AbstractGUICallback {
    ...
    protected void onOpen() {
        this.requestLabel.setDisplayText(I18n.format("oxygen.gui.friends.ignoreCallback.request", this.section.getCurrentEntry().getDisplayText()), false, GUISettings.instance().getTextScale());
    }
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element, int mouseButton) {
        if (element == this.cancelButton)
            ...
            OxygenManagerClient.instance().getFriendListManager().addToIgnoredSynced(this.section.getCurrentEntry().listEntry.playerUUID);
