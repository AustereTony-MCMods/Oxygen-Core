...
public class RemoveFriendGUICallback extends AbstractGUICallback {
    ...
    public RemoveFriendGUICallback(FriendListGUIScreen screen, FriendListGUISection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("oxygen.gui.friends.removeFriendCallback"), true, GUISettings.instance().getTitleScale()));
    ...
    protected void onOpen() {
        this.requestLabel.setDisplayText(I18n.format("oxygen.gui.friends.removeFriendCallback.request", this.section.getCurrentEntry().listEntry.username), false, GUISettings.instance().getTextScale());
    }
