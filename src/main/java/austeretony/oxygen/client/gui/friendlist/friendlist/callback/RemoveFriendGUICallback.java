...
public class RemoveFriendGUICallback extends AbstractGUICallback {
    ...
    protected void onOpen() {
        this.requestLabel.setDisplayText(I18n.format("oxygen.gui.friends.removeFriendCallback.request", this.section.getCurrentEntry().getDisplayText()), false, GUISettings.instance().getTextScale());
    }
