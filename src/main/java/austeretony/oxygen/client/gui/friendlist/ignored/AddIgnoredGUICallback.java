...
public class AddIgnoredGUICallback extends AbstractGUICallback {
    ...
    public AddIgnoredGUICallback(FriendListGUIScreen screen, IgnoreListGUISection section, int width, int height) {
    ...
    public void init() {
        ...
        this.addElement(new GUITextLabel(2, 2).setDisplayText(I18n.format("oxygen.gui.ignored.addIgnoredCallback"), true, GUISettings.instance().getTitleScale())); 
        this.addElement(new GUITextLabel(2, 16).setDisplayText(I18n.format("oxygen.gui.ignored.addIgnoredCallback.request"), false, GUISettings.instance().getTextScale()));  
    ...
    public void handleElementClick(AbstractGUISection section, GUIBaseElement element, int mouseButton) {
        if (element == this.cancelButton)
            ...
            if (this.players.containsKey(this.usernameField.getTypedText())) 
                OxygenManagerClient.instance().getFriendListManager().addToIgnoredSynced(this.players.get(this.usernameField.getTypedText()), this.usernameField.getTypedText());
